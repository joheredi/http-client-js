/**
 * E2E tests for Payload.Xml — validates XML serialization and deserialization
 * for various model shapes including simple models, arrays, attributes,
 * unwrapped arrays, renamed fields, text nodes, dictionaries, and encoded names.
 *
 * Spector spec: payload/xml
 * Mock server: http://localhost:3002
 *
 * Tests verify that:
 * - GET operations correctly deserialize XML responses into TypeScript objects
 * - PUT operations correctly serialize TypeScript objects into XML request bodies
 * - All XML-specific features (attributes, unwrapped arrays, text nodes, etc.) work correctly
 */
