...
import { PageableClient, type Pet } from "../../../generated/payload/pageable/src/index.js";
...
describe("Payload.Pageable", () => {
  ...
  describe("continuationToken", () => {
    it("should get items with requestQueryResponseBody", async () => {
      const result = await client.serverDrivenPagination.continuationToken.requestQueryResponseBody({
        foo: "foo",
        bar: "bar",
      }) as any;
      const pets = result.pets ?? result;
    ...
    it("should get items with requestHeaderResponseBody", async () => {
      const result = await client.serverDrivenPagination.continuationToken.requestHeaderResponseBody({
        foo: "foo",
        bar: "bar",
      }) as any;
      const pets = result.pets ?? result;
    ...
    it("should get items with requestQueryResponseHeader", async () => {
      const result = await client.serverDrivenPagination.continuationToken.requestQueryResponseHeader({
        foo: "foo",
        bar: "bar",
      }) as any;
      const pets = result.pets ?? result;
    ...
    it("should get items with requestHeaderResponseHeader", async () => {
      const result = await client.serverDrivenPagination.continuationToken.requestHeaderResponseHeader({
        foo: "foo",
        bar: "bar",
      }) as any;
      const pets = result.pets ?? result;
